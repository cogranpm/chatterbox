...
public:
	...
	void DictationStopped(const SpeechConstants::DictationCommand command);
	void SoundStart();
	void SoundEnd();
	...
	typedef boost::signals2::signal<void(const SpeechConstants::DictationCommand command)>  type_dictationstopped;
